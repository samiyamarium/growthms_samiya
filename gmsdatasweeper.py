...
st.write(":rosette: You are ready to use the app!! \r  :rosette: Browse a file using above given button to disable the traceback :rosette: appearing below if any appears and enjoy the smooth app!! :rosette: ")
if uploaded_files:

...
st.write(" You are ready to use the app!! :sunglasses: \n  :rosette: Browse a file using above given button to disable the traceback appearing below if any and enjoy the smooth app!! :rosette: ")
if uploaded_files:
